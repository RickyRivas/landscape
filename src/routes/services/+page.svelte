<script>
	...
	import { businessInfo, reviews, allServices } from '../+page';
	// Base
...
<main id="services-int">
	...
	<div class="container">
		{#each allServices as { id, title, description, iconPath, imageUrl }}
			<div class="item">
				<div class="head">
					<img
						class=""
				...
				<div class="body">
					...
					<a class="link" href="/services/{id}">Learn More</a>
				</div>
			</div>
		{/each}
	</div>
